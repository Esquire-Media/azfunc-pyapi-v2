...
async def starter_http_freewheel_audience(req: HttpRequest, client: DurableOrchestrationClient):
    """
    HTTP Trigger to start/restart the Freewheel segment orchestrator.

    The orchestrator fetches audience details and discovers blob paths internally.
    """
    ...
    if req.method == "POST":
        ...
        try:
            await client.start_new(
                orchestration_function_name="freewheel_segment_orchestrator",
